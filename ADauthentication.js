...
//oauth details
const AZUREAD_APP_ID ='c0120762-9b08-4e10-a0ef-54d6a7f79f95'
const AZUREAD_APP_PASSWORD ='nAEp4hAWVkUsBpoJ63n7mYF5YoHM3FOOLFK7A6bu0tw='
const AZUREAD_APP_REALM ='common'
const AUTHBOT_CALLBACKHOST ='http://localhost:3979'
const AUTHBOT_STRATEGY ='oidStrategyv2'
...
console.log("What is there in the address--------------------------------------",address)
